...
<section class="container" style="margin-top: 120px">
    <nav id="breadnav" aria-label="breadcrumb">
        <ol class="breadcrumb nav-block">
            ...
            <li class="breadcrumb-item"><a class="active" href="./fullprotein.php">Full Protein Mode</a></li>
                ...
                <div id="description">
                    ...
                    <div data-scroll-reveal="enter top move 30px over 0.4s after 0.2s">
                        <p class="mb-3">The ability to predict B cell epitopes from antigen sequences is critical for biomedical research
                            ...
                            cell epitopes.</p>
                        <p><strong>Full Protein Mode</strong> identifies potential B cell epitopes from a full antigen protein sequence,
                            this mode requires the antigen protein sequence to be input directly</p></p>
                        <hr>
                    </div>
                </div>
                <div id="usage">
...
<code>--full0=$(cat examples/test_data_BepiTBR_full/example_full.txt) \</code>
<code>--length=15 \</code>
                ...
                <div id="arguments">
                    ...
                    <div data-scroll-reveal="enter top move 30px over 0.4s after 0.2s">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <tr>
                                <th scope="row">full0</th>
                                <td colspan="2">protein sequence</td>
