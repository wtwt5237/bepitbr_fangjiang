...
<section class="container" style="margin-top: 120px">
    <nav id="breadnav" aria-label="breadcrumb">
        <ol class="breadcrumb nav-block">
            <li class="breadcrumb-item"><a class="active" href="./epitope.php">Epitope Mode</a></li>
            <li class="breadcrumb-item"><a href="./fullprotein.php">Full Protein Mode</a></li>
            <li class="breadcrumb-item"><a href="./fasta.php">Fasta Mode</a></li>
        </ol>
    </nav>
                ...
                <div id="description">
                    ...
                    <div data-scroll-reveal="enter top move 30px over 0.4s after 0.2s">
                        <p class="mb-3">The ability to predict B cell epitopes from antigen sequences is critical for biomedical research
                            ...
                            cell epitopes.</p>
                        <p><strong>Epitope Mode</strong> analyzes specific epitopes within proteins. This mode requires epitope sequences and
                            their corresponding full antigen protein sequences</p></p>
                        <hr>
                    </div>
                </div>
                <div id="usage">
...
<code>--motif0_file=examples/test_data_BepiTBR/Ind-positive.txt \</code>
<code>--full0_file=examples/test_data_BepiTBR/peptide_with_full_length.txt \</code>
...
<code>--netMHCIIpan=/home/exampleUser/netMHCIIpan-3.2/netMHCIIpan \</code>
...
<code>--thread=4</code>
                ...
                <div id="arguments">
                    ...
                    <div data-scroll-reveal="enter top move 30px over 0.4s after 0.2s">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <tr>
                                <th scope="row">motif0_file</th>
                                <td>candidate epitopes file</td>

                            </tr>
                            <tr class="table-primary">
                                <th scope="row">full0_file</th>
                                <td colspan="2">full protein sequences file</td>
                ...
                <div id="details" class="mb-3">
                    ...
                    <div data-scroll-reveal="enter top move 30px over 0.4s after 0.2s">
                        ...
                        <p>2. For BepiPred 2.0, this tool requires an isolated python virtual environment <strong>(python 2.7)</strong>.
